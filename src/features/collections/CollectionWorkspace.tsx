...
export function CollectionWorkspace({ onContinuePdf: _onContinuePdf }: CollectionWorkspaceProps) {
  ...
  return <section className="collection-workspace" aria-labelledby="collection-workspace-title">
    <div className="collection-heading"><div><p className="eyebrow"><span className="eyebrow-line" /> Collections</p><h3 id="collection-workspace-title">Several files. One controlled workflow.</h3><p>Add a bounded collection, keep its order visible, choose an explicit goal, and review compatibility before any batch work starts.</p></div><span className="local-badge"><LockKeyhole size={13} /> Memory-only session</span></div>
