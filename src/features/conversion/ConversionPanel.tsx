...
export function ConversionPanel({ currentFile, currentAsset, onContinueResult, onClearParentNotice }: ConversionPanelProps) {
  ...
  return <section className="conversion-panel" aria-labelledby="conversion-panel-title">
    <div className="conversion-panel-heading"><div><p className="eyebrow"><span className="eyebrow-line" /> Convert documents</p><h3 id="conversion-panel-title">Convert without learning the tool name.</h3><p>Choose a source, set a visible target, review the plan, and create validated files in this browser. No upload, cloud converter, or hidden codec dependency is used.</p></div><span className="local-badge"><LockKeyhole size={13} /> Browser-local</span></div>
