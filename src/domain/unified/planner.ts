...
export function planUnifiedWorkflow(asset: FileAsset, goal: string): UnifiedWorkflowPlan {
  ...
  let operation: UnifiedOperation = parsed.status === "valid" ? "pdf.optimize" : isConvert ? "pdf.convert" : isOcr ? "pdf.ocr" : isSearch ? "pdf.search" : isUnderstand ? "pdf.understand" : isEdit ? "pdf.edit" : isOrganize ? "pdf.organize" : "unsupported";
