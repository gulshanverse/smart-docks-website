...
SmartDocs is an intent-first, local-first workspace for turning human image, PDF, or supported Office document goals into measured and verified results. **Phase 14 adds resumable, human-supervised automation and reliability controls** above the completed Phase 1–13 image, PDF, OCR, AI, safe-action, conversion, Office, collection, workflow orchestration, and structured extraction engines.
...
Phase 14 document intelligence automation and reliability is the current milestone. It extends Phase 12 orchestration and Phase 13 extraction with metadata-only resumable sessions, validated checkpoints, failure isolation, bounded safe retries, human review checkpoints, quality gates, cross-document reconciliation, evidence graphs, audit timelines, partial-result preservation, and final package manifests. See [`docs/phase-14-automation-reliability.md`](docs/phase-14-automation-reliability.md), [`docs/phase-14-security.md`](docs/phase-14-security.md), and [`docs/phase-14-browser-verification.md`](docs/phase-14-browser-verification.md). It does not pretend to provide arbitrary code execution, unbounded batch queues, universal Office round-trips, formula recalculation, ZIP packaging, object-level PDF compression, cloud conversion, autonomous actions, or forensic metadata guarantees. Unsupported executor capabilities fail honestly and future expansion must remain separately verified.
